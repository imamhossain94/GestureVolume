...
/**
 * The apps the bar steps aside for.
 *
 * Knowing which app is in front takes the accessibility service, so the screen says so plainly and
 * offers to turn it on rather than letting the list quietly do nothing.
 */
