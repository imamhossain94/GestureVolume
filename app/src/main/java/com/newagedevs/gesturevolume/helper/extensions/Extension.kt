package com.newagedevs.gesturevolume.helper.extensions
...
fun shareApp(context: Context) {
    val shareIntent = Intent(Intent.ACTION_SEND).apply {
        type = "text/plain"
        putExtra(Intent.EXTRA_TEXT, "http://play.google.com/store/apps/details?id=${context.packageName}")
    }
...
System: $androidVersion
    ...
    try {
        ...
        context.toast("There are no email apps installed on your device")
    }
}
